...
powershell -Command "try{Invoke-WebRequest 'http://localhost:31000/api/system/check' -UseBasicParsing -TimeoutSec 1|Out-Null;exit 0}catch{exit 1}" >nul 2>&1
